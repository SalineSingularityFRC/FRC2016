...
public class AutonArmdown implements AutonMode {
	...
	public AutonArmdown(SingularityDrive drive, SingularityConveyer conveyer, SingularityArm arm, SingularityClimb climb) {
		this.drive = drive;
