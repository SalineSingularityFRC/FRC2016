...
public class AutonForward implements AutonMode {
	...
	public AutonForward(SingularityDrive drive, SingularityConveyer conveyer, SingularityArm arm, SingularityClimb climb) {
		this.drive = drive;
