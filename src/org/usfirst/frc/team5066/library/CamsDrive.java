...
public class CamsDrive {
	 ...
	 */
	public CamsDrive(int frontLeftMotor, int rearLeftMotor, int frontRightMotor, int rearRightMotor) {
	 ...
	 */
	public CamsDrive(SpeedController frontLeftMotor, SpeedController rearLeftMotor,
